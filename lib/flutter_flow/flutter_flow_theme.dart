...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4855A4);
  late Color secondary = const Color(0xFFFA5D3E);
  late Color tertiary = const Color(0xFFB8E2FF);
  late Color alternate = const Color(0xFFFFD4D4);
